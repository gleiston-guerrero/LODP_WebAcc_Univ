...
Se depositan dos codificaciones independientes de esta ronda. La primera se recogi\'o el 8 de septiembre de 2026 y la segunda el 9 de septiembre, por un segundo evaluador que trabaj\'o a partir de un protocolo escrito, sin acceso a la primera codificaci\'on, a las rondas anteriores ni al borrador de este art\'iculo. Sobre las tres reglas que decide la propia regla, \texttt{23a2a8}, \texttt{afw4f7} y \texttt{c487ae}, las dos codificaciones coinciden en 3\,186 de 3\,189 comparaciones por elemento, esto es el 99,9\,\%, con una $\kappa$ de Cohen de 0,996 (IC 95\,\% de 0,991 a 1,000) e id\'entica prevalencia de la categor\'ia mayoritaria, el 86,7\,\% en ambas; el acuerdo sobre qu\'e elementos son aplicables a las reglas es del 99,1\,\% ($\kappa=0{,}981$). Esa cifra estima la reproducibilidad del instrumento entre operadores independientes y no es un coeficiente de fiabilidad entre codificadores. El segundo evaluador resolvi\'o las filas de juicio el 11 de septiembre de 2026, lo que hace posible una comparaci\'on sobre las tres reglas restantes: las dos codificaciones coinciden entonces en 179 de 230 comparaciones por elemento, el 77,8\,\%, y devuelven el mismo veredicto en 43 de las 45 celdas de sitio por criterio, el 95,6\,\%. Esos totales mezclan dos procedencias y el dep\'osito las separa, porque solo una de las dos es fiabilidad entre codificadores. En las 62 comparaciones cuyo resultado de la primera codificaci\'on lo decidi\'o un codificador humano, todas ellas enlaces del criterio 2.4.4, el acuerdo observado es del 82,3\,\% con una $\kappa$ de Cohen de 0,178 (IC 95\,\% de $-0{,}262$ a 0,619); en las 168 comparaciones del criterio 1.1.1 el resultado de la primera codificaci\'on proviene de la resoluci\'on hecha con la asistencia de un sistema de inteligencia artificial generativa, que la declaraci\'on al final de este art\'iculo excluye de las estimaciones de acuerdo, y el 76,2\,\% de acuerdo de ese grupo ($\kappa=0{,}390$) se reporta, por tanto, como acuerdo y no como fiabilidad. La estimaci\'on entre codificadores que esta ronda sostiene es, as\'i, solo la primera, y es demasiado imprecisa para sostener una conclusi\'on: sus 62 comparaciones son los enlaces de una sola instituci\'on, 49 de ellas codificadas como satisfactorias por los dos codificadores, y su intervalo incluye el cero. No establece ni refuta la fiabilidad en las reglas de juicio, y el art\'iculo no extrae de ella ninguna inferencia. Las dos diferencias a nivel de sitio, ambas en el criterio 1.1.1, se nombran y se trazan elemento por elemento en el dep\'osito.
...
Dos de esas 25 celdas las lee de otro modo la segunda codificaci\'on de la ronda, que no encuentra fallo del criterio 1.1.1 ni en ECOTEC ni en UC Berkeley; con esa lectura el recuento ser\'ia de 23 de 39 celdas, el 59\,\% en lugar del 61\,\%. Las dos diferencias giran sobre la misma pregunta, si un nombre accesible que describe algo distinto de la imagen que etiqueta sirve un prop\'osito equivalente al de ella, y las dos quedan registradas elemento por elemento, con las justificaciones escritas de los codificadores, en el dep\'osito. El hallazgo de esta subsecci\'on es el orden de magnitud de la carencia y no depende de cu\'al de las dos lecturas se adopte.
...
\emph{Estabilidad de la medici\'on.} La revisi\'on documental sigue siendo una observaci\'on \'unica. El estado de las cookies previas al consentimiento no es determinista: depende de pruebas A/B, de subastas publicitarias, del nodo de la red de distribuci\'on de contenidos (CDN) y del momento del despliegue. Para la auditor\'ia en vivo esto se abord\'o con las tres pasadas por punto de observaci\'on, cuyo acuerdo entre pasadas oscil\'o entre el 95,9\,\% y el 100\,\%; para la comparaci\'on entre grupos de la Secci\'on~\ref{sec:results-cookies}, que descansa en la medici\'on de pasada \'unica de agosto, no. Entre ocasiones el dep\'osito la acota ya para la medici\'on de rastreo: una segunda serie de ETAPA de tres pasadas el 14 de septiembre de 2026, manteniendo fijos el operador, la ciudad, la m\'aquina, el instrumento y las versiones de software, devuelve el 68,0\,\% de sitios con rastreo en las dos ocasiones, con dos de 125 sitios discordantes (McNemar exacta $p=1{,}000$). Eso acota la deriva del veredicto de rastreo en un mes; nada dice de la medici\'on de accesibilidad, que no tiene segunda ocasi\'on. Solo se audit\'o la portada, mientras que la conformidad con las WCAG se define sobre p\'aginas y procesos completos, y las rutas transaccionales que este art\'iculo invoca como motivaci\'on, la admisi\'on y la matr\'icula, no se midieron en absoluto. Los detectores de banner y de CMP son heur\'isticos cuyas tasas de falsos negativos se desconocen.
...
\emph{Validez externa.} Todas las observaciones se tomaron en una fecha y desde un pa\'is, y los resultados describen el estado de 126 portadas en agosto de 2026. El contenido web cambia; ninguna afirmaci\'on de este art\'iculo debe leerse como propiedad duradera de instituci\'on alguna. Un mes despu\'es, con el mismo operador, la misma ciudad, la misma m\'aquina y el mismo instrumento, el veredicto de rastreo previo al consentimiento cambi\'o en dos de 125 sitios, lo que acota esa deriva sin volver duradera ninguna parte de ella; la medici\'on de accesibilidad no tiene segunda ocasi\'on y no queda acotada del mismo modo.
...
Todas las decisiones que se reportan en este art\'iculo las tomaron los autores, que operaron cada instrumento y ejecutaron cada an\'alisis y son responsables de la versi\'on final del texto. Un asistente de inteligencia artificial generativa se us\'o como herramienta bajo esa responsabilidad: para revisar y corregir prosa y scripts auxiliares de an\'alisis del manuscrito y del dep\'osito, y para redactar algunos de esos pasajes y scripts, revisados despu\'es por el primer autor; y para recalcular cantidades reportadas a partir de los datos depositados como comprobaci\'on del manuscrito. No se emple\'o para recoger datos, para operar el instrumento de auditor\'ia, para seleccionar o interpretar observaciones, ni para decidir lo que el estudio concluye, y no gener\'o ninguna medici\'on, tabla ni figura; el instrumento y las versiones de software son los que dan las Secciones~\ref{sec:methods-audit}, \ref{sec:methods-manual} y \ref{sec:methods-stats}. No satisface los criterios de autor\'ia de esta revista y no se le acredita como autor.

Un uso alcanz\'o los datos, y queda registrado como tal: de los 349 elementos de imagen que la regla \texttt{qt1vmo} remite al juicio humano, 345 se resolvieron con su asistencia y fueron revisados por el primer autor, y los cuatro restantes los resolvi\'o el primer autor por s\'i solo. Ambos grupos llevan su c\'odigo de evaluador en el dep\'osito, el grupo asistido queda excluido de cualquier estimaci\'on de acuerdo entre codificadores, y la Secci\'on~\ref{sec:results-wcag} reporta por eso la cifra del criterio 1.1.1 como acuerdo y no como fiabilidad.
